        ...
        <>
            ...
            <section className="container mt-5">
                ...
                <div className="pagination flex items-center justify-center mt-4">
                    <button onClick={handlePrevPage} disabled={currentPage === 1} class="mr-2 px-3 py-1 btn btn-danger disabled:bg-gray-300 disabled:text-gray-500 disabled:cursor-not-allowed">
                        Previous
                    </button>
                    <span class="text-danger text-lg font-weight-bold mx-4">
                        Page {currentPage} of {totalPages}
                    </span>
                    <button onClick={handleNextPage} disabled={currentPage === totalPages} class="ml-2 px-3 py-1 btn btn-danger disabled:bg-gray-300 disabled:text-gray-500 disabled:cursor-not-allowed">
                        Next
                    </button>
