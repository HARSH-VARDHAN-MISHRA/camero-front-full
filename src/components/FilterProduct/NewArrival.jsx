...
const NewArrival = () => {
    ...
    const handleData = async () => {
        try {
            ...
            const filterProduct = productss.filter((item) => item.property === "New Arrival")
                ...
                <div className="container">
                    ...
                    {productData.length > 8 && !showAll && (
                        <div className="view-more">
                            <Link onClick={() => setShowAll(true)} >View All Products <i class="fa-solid fa-arrow-right"></i> </Link>
                        </div>
                    )}
                </div>
            </section>
